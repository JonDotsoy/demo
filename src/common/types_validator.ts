...
export const hasProperty = <T extends string>(
  ...
  isObject(value) && Reflect.has(value, prop);
...
): value is T[] => value.every(test);

export const parseConfigEditor = (value: unknown) =>
  isObject(value) &&
...
export const parseConfigEditorWatch = (value: unknown) =>
  isObject(value) &&
...
export const parseConfigDemoLocation = (value: unknown) =>
  isObject(value) &&
